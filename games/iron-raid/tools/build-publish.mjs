...
// external art/audio (see docs/ASSET_SPEC.md) is loaded at runtime from ./content/
cpSync(new URL('../content', import.meta.url), new URL('../../../dist/iron-raid/content', import.meta.url), { recursive: true });
